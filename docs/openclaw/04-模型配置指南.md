...
| GPT-4o | `gpt-4o` | 多模态，速度快 | 日常对话、图片理解 |
| GPT-4o-mini | `gpt-4o-mini` | 便宜快速 | 简单任务、高频调用 |
| o3 | `o3` | 深度推理 | 数学、逻辑、科学 |
...
| 场景 | 推荐模型 | 理由 | 大约成本 |
|------|----------|------|----------|
| 日常闲聊 | GPT-4o-mini / Haiku 4.5 | 便宜快速，够用 | ~$0.15/百万 token |
...
| 多模态 | Gemini 3.1 / GPT-4o | 图片视频理解 | ~$2.5/百万 token |
...
```json5
{
  ...
  // openclaw models aliases add translator "openai/gpt-4o"
}
```
